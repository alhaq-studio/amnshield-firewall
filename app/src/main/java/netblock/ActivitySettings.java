...
public class ActivitySettings extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    private static final String TAG = "DeenShield AppControl.Settings";
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        // Port forwarding removed for Play Store compliance
        /*
        ...
        */
        ...
        // Hosts file settings
        // Removed adblocker preferences for Play Store compliance
        /*
        ...
        */
        ...
        // Adblocker code removed for Play Store compliance
        /*
        if (Util.isPlayStoreInstall(this)) {
    ...
    private Intent getIntentCreateExport() {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            ...
            intent.putExtra(Intent.EXTRA_TITLE, "netblock_" + new SimpleDateFormat("yyyyMMdd").format(new Date().getTime()) + ".xml");
        }
        return intent;
    }
            ...
            protected Throwable doInBackground(Object... objects) {
                ...
                try {
                    ...
                    if (data.hasExtra("org.openintents.extra.DIR_PATH"))
                        target = Uri.parse(target + "/netblock_" + new SimpleDateFormat("yyyyMMdd").format(new Date().getTime()) + ".xml");
    ...
    private void xmlExport(OutputStream _out) throws IOException {
        ...
        serializer.startTag(null, "netblock");
        ...
        serializer.endTag(null, "netblock");
