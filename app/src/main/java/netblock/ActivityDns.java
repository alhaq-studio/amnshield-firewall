...
public class ActivityDns extends AppCompatActivity {
    private static final String TAG = "DeenShield AppControl.DNS";
    ...
    private Intent getIntentExport() {
        ...
        intent.putExtra(Intent.EXTRA_TITLE, "netblock_dns_" + new SimpleDateFormat("yyyyMMdd").format(new Date().getTime()) + ".xml");
        return intent;
    }
