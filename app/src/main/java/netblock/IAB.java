...
public class IAB implements ServiceConnection {
    private static final String TAG = "DeenShield AppControl.IAB";
    ...
    public PendingIntent getBuyIntent(String sku, boolean subscription) throws RemoteException {
        if (service == null)
            return null;
        Bundle bundle = service.getBuyIntent(IAB_VERSION, context.getPackageName(), sku, subscription ? "subs" : "inapp", "netblock");
