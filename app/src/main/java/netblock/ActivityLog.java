...
public class ActivityLog extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    private static final String TAG = "DeenShield AppControl.Log";
                    ...
                    public boolean onMenuItemClick(MenuItem menuItem) {
                        switch (menuItem.getItemId()) {
                            ...
                            case R.id.menu_copy:
                                ...
                                ClipData clip = ClipData.newPlainText("netblock", dname == null ? daddr : dname);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_log_support:
                ...
                intent.setData(Uri.parse("https://github.com/M66B/DeenShield AppControl/blob/master/FAQ.md#user-content-faq27"));
    ...
    private Intent getIntentPCAPDocument() {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            ...
            intent.putExtra(Intent.EXTRA_TITLE, "netblock_" + new SimpleDateFormat("yyyyMMdd").format(new Date().getTime()) + ".pcap");
        }
        return intent;
    }
